...
import 'package:flutter_repo_guide/screens/albumes_id_artista_screen.dart';
    ...
    return Drawer(
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(
            title: const Text('Albumes por Id del Artista - Caba'),
            onTap: () {
              Navigator.pop(context); // Cierra el drawer antes de navegar
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => AlbumIdArtistaScreen()),
              );
            },
          ),
          ListTile(
            title: const Text('Cancionero del album - Caba'),
            onTap: () {
              Navigator.pop(context); // Cierra el drawer antes de navegar
              Navigator.push(
                context,
